...
\textit{e-mail}: nrp@student.its.ac.id}
\date{}
...
\input{bagian/01-pendahuluan}
\input{bagian/02-metodologi}
\input{bagian/03-hasil-pembahasan}
\input{bagian/04-kesimpulan}
\input{bagian/05-lampiran}
\input{bagian/06-ucapan-terima-kasih}
